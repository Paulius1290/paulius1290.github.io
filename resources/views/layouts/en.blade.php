        ...
        <div class="flex space-x-4">
          ...
          <div>
            <a href="{{route('home')}}" class="flex items-center py-5 px-2 text-black hover:text-gray-800">
              ...
              <span class="font-bold">Academy of Science</span>
            </a>
          </div>

          {{-- primary nav --}}
          <div class="flex items-center space-x-1">
            <a href="{{ route('en.apiemus') }}" class="py-5 px-3 text-gray-700 hover:text-gray-900">About us</a>
            <a href="#" class="py-5 px-3 text-gray-700 hover:text-gray-900">Modules</a>
          </div>
        </div>

          {{-- secondary nav --}}
          @guest
          <a href="{{ route('en.kontaktai') }}">Contacts</a>
          <div class="flex items-center space-x-1">
            @if (Route::has('login'))
