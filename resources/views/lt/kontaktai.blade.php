...
@section('content')
<body class="background" style="background-position: center; background-repeat: no-repeat; background-size: cover; background-image: url('/image/cool-background.png');">
<div class="card ml-auto mr-auto">
    <div class="card-front">
      <p class="title">Raimundas Dabrila</p>
      <p class="subtitle">Vadovas</p>
    </div>
    <div class="card-back text-center">
      <p>Susisiekite su mumis šiuo email: </p>
